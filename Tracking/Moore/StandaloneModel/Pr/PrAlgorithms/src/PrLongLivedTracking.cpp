...
#include "/home/hashmi/ResearchBook/Tracking/Models/StandaloneDownstreamModel_.cpp"
  ...
  DownstreamTracks operator()( const EventContext& evtCtx, const LHCb::Pr::Seeding::Tracks& InputTracks,
    ...
    for ( const auto& _tr : InputTracks.scalar() ) {
      ...
      if (bestCandidate){
        ...
        const std::vector<float> scaler_min = {1.37456251e+03,  5.12070907e+00, -4.09728527e-01, -2.65848875e-01,
       -7.70063110e+02, -6.20070984e+02,  1.57686504e+00, -3.14158511e+00,
        3.00000000e+00,  1.88820646e-03};
        const std::vector<float> scaler_max = {5.42134504e+06, 2.75413205e+05, 4.02373552e-01, 2.66040862e-01,
       ...
       8.00000000e+00, 4.99900770e+00};
        ...
        const float rawValue = ApplyDownstreamModel(scaled_features);
