...
#include "/home/hashmi/ResearchBook/Tracking/Models/StandaloneSciFiModel_.cpp"
...
namespace LHCb::Pr {
  ...
  void HybridSeeding::makeLHCbTracks( const FT::Hits& sciFiHits, Tracks& result, unsigned int part,
    ...
    for ( const auto& track : trackCandidates[part] ) {
      ...
      const std::vector<float> scaler_min = {9.00000000e+00, -1.06425428e+00, -3.90152931e-01, -2.64307129e+03,
       -2.08921777e+03,  8.01983887e-01, -3.14159238e+00,  1.51493319e-03};
      const std::vector<float> scaler_max = {1.20000000e+01, 1.09440386e+00, 4.07895654e-01, 2.64208813e+03,
